  ...
  return (
    <div className="hero text-[#0B0E13]">
      <div className="hero-content flex flex-col lg:my-16">
        <div className="lg:flex gap-16 w-full lg:mx-10">
          <motion.div
            initial={{ opacity: 0 }}
            ...
            className="w-full"
          >
            <h1 className="text-3xl font-main">WINE BY THE GLASS (100 ML)</h1>
              ...
              <div className="my-4">
                ...
                <div>
                  <div className="flex items-end mt-3 gap-1 w-full">
                    ...
                    <span className="w-full border-b-2 mb-2 border-dashed border-neutral"></span>
                    <p className="text-xl font-sub text-secondary">$29</p>
                  </div>
          ...
          <motion.div
            ...
            className="w-full"
          >
            <h1 className="text-3xl font-main">HALF BOTTLES (375 ML)</h1>
            <div className="text-secondary my-2 w-16 flex items-center">
              <span className="mr-2">
                <GoPrimitiveDot></GoPrimitiveDot>
              </span>
